            ...
            <div className="lg:w-1/2 lg:mx-6">
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    ...
                    <p className="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72">info@pbtracker.com</span>
                    </p>
                </div>
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div
                    ...
                    <form className="mt-6">
                        ...
                        <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-custom-blue-color rounded-md hover:bg-custom-blue-color-dark focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                            get in touch
                        </button>
                    </form>
                </div>
