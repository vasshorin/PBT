        ...
        <>
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-xl font-bold">Your Cnpmredit Cards</h2>
...
// const CreditCards = ({ refreshToken }) => {
//     const [creditCards, setCreditCards] = useState([]);
//     const [creditCardName, setCreditCardName] = useState('');
//     const [creditCardBalance, setCreditCardBalance] = useState(0);
//     const [creditCardLimit, setCreditCardLimit] = useState(0);
...
//             'https://crabby-plum-getup.cyclic.app/api/newCreditCard',
//             {
//                 name: creditCardName,
//                 currentBalance: creditCardBalance,
//                 creditLimit: creditCardLimit,
...
//     const handleRemoveCreditCard = async (creditCardId) => {
//         await axios.delete(`https://crabby-plum-getup.cyclic.app/api/deleteCreditCard/${creditCardId}`, {
//             headers: {
//                 'auth-token-refresh': refreshToken,
//             },
//         });
...
//     const handleUpdateCreditCard = async (creditCardId) => {
//         await axios.put(
//             `https://crabby-plum-getup.cyclic.app/api/updateCreditCard/${creditCardId}`,
//             {
//                 name: creditCardName,
//                 currentBalance: creditCardBalance,
//                 creditLimit: creditCardLimit,
...
//         setCreditCards(
//             creditCards.map((creditCard) => (creditCard._id === creditCardId ? { ...creditCard, name: creditCardName } : creditCard))
//         );
//     };

//     const handlePaymentCalculation = (creditCard) => {
//         const minimumPayment = creditCard.currentBalance * 0.02;
//         const interest = (creditCard.currentBalance * creditCard.interestRate) / 100;
//         const totalPayment = minimumPayment + interest;

//         return { minimumPayment, interest, totalPayment };
//     };
...
//                                 className={`mr-2 text-gray-700 text-sm font-bold w-full ${toolDisplayPressed ? '' : 'hidden'}`}
// >
//                             Name:
//                         </label>
//                         <input
...
//                             className={`mr-2 text-gray-700 text-sm font-bold ${toolDisplayPressed ? '' : 'hidden'}`}
// >
//                         Balance:
//                     </label>
//                     <input
