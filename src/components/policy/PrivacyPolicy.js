...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <p className="text-center text-lg font-bold mb-4">Last updated: 2021-10-01</p>

      <h1 className="text-2xl font-bold mb-2">Privacy Policy</h1>
      <p className="mb-4">Last updated: May 20, 2023</p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank" rel="noopener noreferrer">Privacy Policy Generator</a>.
      </p>

      <h1 className="text-2xl font-bold mb-2">Interpretation and Definitions</h1>
      ...
      <ul className="list-disc ml-8 mb-4">
        ...
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Person
          Budget Tracker.
        </li>
        <li>
        ...
        <li>
          <strong>Third-party Social Media Service</strong> refers to any website or any social network website through which a
        ...
        <li>
          <strong>Website</strong> refers to Person Budget Tracker, accessible from https://www.example.com
        </li>
        <li>
      ...
      <h1 className="text-2xl font-bold mb-2">Collecting and Using Your Personal Data</h1>
      ...
      <h1 className="text-2xl font-bold mb-2">Use of Your Personal Data</h1>
      <p className="mb-4">The Company may use Personal Data for the following purposes:</p>
      <ul className="list-disc ml-8 mb-4">
        <li>To provide and maintain our Service, including to monitor the usage of our Service.</li>
        <li>To manage Your Account: to manage Your registration as a user of the Service. The Personal Data You provide can give
      ...
      <h1 className="text-2xl font-bold mb-2">Retention of Your Personal Data</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-bold mb-2">Transfer of Your Personal Data</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-bold mb-2">Disclosure of Your Personal Data</h1>
      <h2 className="text-lg font-bold mb-2">Business Transactions</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-bold mb-2">Law enforcement</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-bold mb-2">Other legal requirements</h2>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-bold mb-2">Security of Your Personal Data</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-bold mb-2">Children's Privacy</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-bold mb-2">Links to Other Websites</h1>
      <p className="mb-4">
      ...
      <h1 className="text-2xl font-bold mb-2">Changes to this Privacy Policy</h1>
      <p className="mb-4">
      ...
      <ul className="list-disc ml-8 mb-4">
        <li>By email: <a href="mailto:info@pbtracker.com">info@pbtracker.com</a></li>
      </ul>
